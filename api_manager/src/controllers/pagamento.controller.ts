...
export function gerarPayloadPix({
  ...
  const merchantAccountInfo =
    '26' + formatSize(merchantAccountInfoValue) + merchantAccountInfoValue;
  ...
  const additionalDataField =
    '62' + formatSize(additionalDataFieldValue) + additionalDataFieldValue;
...
export async function gerarPixController(req: Request, res: Response) {
