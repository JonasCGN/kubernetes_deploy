...
import {
    adicionarProdutoInsumosController,
    removerProdutoInsumoController,
    atualizarQuantidadeProdutoInsumoController,
    removerTodosInsumosDoProdutoController,
    listarInsumosPorProdutoController
} from '../controllers/produtoInsumo.controller';
 ...
 */
router.get('/:id/insumos', listarInsumosPorProdutoController);
 ...
 */
router.post('/:id/insumos', adicionarProdutoInsumosController); // middelware
 ...
 */
router.delete('/:id/insumos/:insumoId', removerProdutoInsumoController); // middelware
 ...
 */
router.patch('/:id/insumos/:insumoId', atualizarQuantidadeProdutoInsumoController); // middelware
 ...
 */
router.delete('/:id/insumos', removerTodosInsumosDoProdutoController); // middelware
