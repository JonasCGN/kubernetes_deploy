...
import {
    ...
    listarPedidosHojeController,
    atualizarPedidoController
} from '../controllers/pedido.controller';

import { finalizarPedido } from '../controllers/finalizarPedidoCompleto.controller';
 ...
 */
router.get('/', listarPedidos); // middleware
 ...
 */
router.get('/hoje', listarPedidosHojeController); // lista pedidos de hoje
 ...
 */
router.get('/:id', buscarPedidoPorId); // middleware
 ...
 */
router.patch('/:id/status', atualizarStatusPedidoController); // atualiza status
 ...
 *         description: Pedido não encontrado
 */
router.patch('/:id', atualizarPedidoController);
 ...
 */
router.post('/finalizar-completo', finalizarPedido);
