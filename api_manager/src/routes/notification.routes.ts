...
import { sendNotificationApp, sendNotificationWhatsapp } from '../controllers/notification.controller';
 ...
 */
router.post('/sendApp', sendNotificationApp);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/sendWhatsapp',sendNotificationWhatsapp);
