...
const pedidoProduto_controller_1 = require("../controllers/pedidoProduto.controller");
 ...
 */
router.post('/:id/produto', supabaseAuth_1.requireAuthStaff, pedidoProduto_controller_1.adicionarProdutoAoPedido);
/**
 * @swagger
 ...
 *         description: Acesso negado
 */
router.patch('/:id/produto/:produtoId', supabaseAuth_1.requireAuthStaff, pedidoProduto_controller_1.atualizarProdutoDoPedido);
/**
 * @swagger
 * /pedido/{id}/produto/{produtoId}:
 *   delete:
 ...
 *         description: Acesso negado
 */
router.delete('/:id/produto/:produtoId', supabaseAuth_1.requireAuthStaff, pedidoProduto_controller_1.removerProdutoDoPedido);
